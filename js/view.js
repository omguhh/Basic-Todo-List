...
(function (window) {
    ...
    View.prototype._completeItem = function (id,completed) {
        var elem = qs('[data-id="' + id + '"]');
    ...
    View.prototype.render = function (viewCmd, parameter) {
        ...
        var viewCommands = {
            ...
            completeItem: function () {
                that._completeItem(parameter,parameter.completed);
            },
            removeItem: function () {
            ...
            elementComplete: function () {
				          that._completeItem(parameter.id, parameter.completed);
                }
        };
    ...
    View.prototype.bind = function (event, handler) {
        ...
        if (event === 'newTodo') {
			...
			$live('#todo-list input', 'click', function () {
				handler({
					id: that._itemId(this),
